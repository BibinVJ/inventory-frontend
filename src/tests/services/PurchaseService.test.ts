...
describe('PurchaseService', () => {
  ...
  it('should fetch purchases', async () => {
    const response = { data: [mockPurchase] };
  ...
  it('should add a purchase', async () => {
    const newPurchase: PurchasePayload = { vendor_id: '2', invoice_number: 'INV-003', purchase_date: '2024-02-01', items: [] };
    mockedApi.post.mockResolvedValue({ data: newPurchase });
  ...
  it('should update a purchase', async () => {
    const updatedPurchase: PurchasePayload = { vendor_id: '3', invoice_number: 'INV-004', purchase_date: '2024-03-01', items: [] };
    mockedApi.put.mockResolvedValue({ data: updatedPurchase });
